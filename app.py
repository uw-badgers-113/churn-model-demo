...
# These MUST match the category strings the model was trained on.
INCOME_CHOICES    = ["very high", "high", "medium", "low"]
EDUCATION_CHOICES = ["post graduate", "graduate", "high school", "other"]
DEVICE_CHOICES    = ["mobile", "desktop", "tablet"]   # <-- set to your data's values
